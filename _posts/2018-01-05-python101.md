...
<li>[Relationships/Booleans](#relations) </li>
<li>[Variables](#variables) </li>
<li>[Sequences](#sequences)
  <ul>
    <li>[Strings](#strings) </li>
    <li>[Lists](#lists) </li>
  </ul>
</li>
<li>[Conditionals](#conditionals)</li>
  <ul>
    <li>[If statements](#if-statements) </li>
    <li>[Boolean operations](#boolean-ops) </li>
  </ul>
</li>
<li>[Looping](#looping)
  <ul>
    <li>[For statements](#for-loops) </li>
    <li>[While statements](#while-loops) </li>
  </ul>
</li>
...
```python
# code to get a random number -- search for the "random" module to learn more
import random
...
A bit of syntax for classes: we begin a class definition with ``class ClassName:``. Since our class is for a student, we'll name it ``Student`` - ``class Student:``. We then need to provide a **constructor** for our class. A **constructor** is a function that is called when we want to create, or _construct_, an instance of our class.
...
Okay, now that we have the ``Student`` class written, it's time to start writing the ``Course`` class, which will represent the courses that students are taking.
